...
on C++, and only a subset of its functionality is available from Python.
...
Florian Bruhin is a long-time contributor and maintainer of both the pytest tool
and the pytest-qt plugin. He's using PyQt since 2013 with his qutebrowser
project, a keyboard-focused web browser based on Python and QtWebEngine. In
2015, he discovered pytest - since then, he gave talks and conducted workshops
about pytest at various conferences and companies.
